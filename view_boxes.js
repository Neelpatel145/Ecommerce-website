                    ...
                    <div class="panel panel-primary"><!-- panel panel-primary begin -->
                        ...
                        <div class="panel-footer"><!-- panel-footer begin -->
                            <center><!-- center begin -->
                                ...
                                <a href="/index.ejs/<%= delete_box=console.log(box_id); %>" class="pull-right"><!-- pull-right begin -->
                                
                                 <i class="fa fa-trash"></i> Delete
                                
                                </a><!-- pull-right finish -->
                                
                                <a href="/index.ejs/<%= edit_box=console.log(box_id); %>" class="pull-left"><!-- pull-left begin -->
