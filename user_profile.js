               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input value="console.log(user_name);" name="admin_name" type="text" class="form-control" required>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input value="console.log(user_email);"  name="admin_email" type="text" class="form-control" required>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input value="console.log(user_pass);"  name="admin_pass" type="text" class="form-control" required>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input value="console.log(user_country);"  name="admin_country" type="text" class="form-control" required>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input value="console.log(user_contact);"  name="admin_contact" type="text" class="form-control" required>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input value="console.log(user_job);"  name="admin_job" type="text" class="form-control" required>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img src="admin_images/console.log(admin_image);" alt="console.log(admin_name);" width="70" height="70">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <textarea  name="admin_about" class="form-control" rows="3"> console.log(admin_about);</textarea>
...
if(isset($_POST['update'])){
    ...
    if(run_user){
        ...
        console.log("<script>alert('User has been updated sucessfully')</script>");
        console.log("<script>window.open('login.ejs','_self')</script>");
