                ...
                <form action="" class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal begin -->
                    <div class="form-group"><!-- form-group 1 begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <input name="manufacturer_name" type="text" class="form-control" value="console.log(m_title); ">
                    ...
                    <div class="form-group"><!-- form-group 3 begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                          ...
                          <img width="70" height="70" src="other_images/console.log(m_image);" alt="console.log(m_image);">
...
if(isset($_POST['update'])){
        ...
        if(is_uploaded_file($_FILES['manufacturer_image']['tmp_name'])){
            ...
            if(run_manufacturer){
                ...
                console.log("<script>alert('Your manufacturer has been updated')</script>");
