                          ...
                          <select name="product_id" class="form-control" required>
                            ...
                            run_p = mysqli_query(con,get_p);
                                ...
                                while(row_p = mysqli_fetch_array(run_p)){
                                    ...
                                    console.log("<option value='p_id'>p_title</option>");
...
if(isset($_POST['submit'])){
    ...
    if(check_coupons==1){
        ...
        console.log("<script>alert('Coupon Code / Product Already Added. Choose Another Coupon Code / Product')</script>");
        ...
        if(run_coupon){
            ...
            console.log("<script>alert('Your Coupon Has Been Created')</script>");
            console.log("<script>window.open('index.ejs?view_coupons','_self')</script>");
