               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="product_title" type="text" class="form-control" required value="console.log(p_title);">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <select name="manufacturer" class="form-control"><!-- form-control Begin -->
                              ...
                              <option selected value="console.log(manufacturer_id); "> console.log(manufacturer_title); </option>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <select name="product_cat" class="form-control"><!-- form-control Begin -->
                              ...
                              <option value="console.log(p_cat); "> console.log(p_cat_title); </option>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <select name="cat" class="form-control"><!-- form-control Begin -->
                              ...
                              <option value="console.log(cat);"> console.log(cat_title); </option>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img width="70" height="70" src="product_images/console.log(p_image1);" alt="console.log(p_image1);">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img width="70" height="70" src="product_images/console.log(p_image2);" alt="console.log(p_image2);">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img width="70" height="70" src="product_images/console.log(p_image3);" alt="console.log(p_image3);">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="product_price" type="text" class="form-control" required value="console.log(p_price);">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="product_sale" type="text" class="form-control" required value="console.log(p_sale);">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="product_keywords" type="text" class="form-control" required value="console.log(p_keywords); ">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="product_label" type="text" class="form-control" required value="console.log(p_label);">
...
if(isset($_POST['update'])){
    ...
    if(is_uploaded_file($_FILES['file']['tmp_name'])){
        ...
        console.log("<script>alert('Your product has been updated Successfully')</script>"); 
