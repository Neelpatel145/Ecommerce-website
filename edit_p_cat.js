                ...
                <form action="" class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal begin -->
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <input value="console.log(p_cat_title);" name="p_cat_title" type="text" class="form-control">
                    ...
                    <div class="form-group"><!-- form-group 2 begin -->
                        ...
                        <input name="p_cat_top" type="radio" value="yes"
                            ...
                            if(p_cat_top=='no'){}else{console.log("checked='checked'");}
                        ...
                        <input name="p_cat_top" type="radio" value="no"
                            ...
                            if(p_cat_top=='no'){console.log("checked='checked'");}
                    ...
                    <div class="form-group"><!-- form-group 3 begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                          ...
                          <img width="70" height="70" src="other_images/console.log(p_cat_image);" alt="console.log(p_cat_image);">
...
if(isset($_POST['update'])){
              ...
              if(is_uploaded_file($_FILES['p_cat_image']['tmp_name'])){
                ...
                if(run_p_cat){
                    ...
                    console.log("<script>alert('Your Product Category Has Been Updated')</script>");
