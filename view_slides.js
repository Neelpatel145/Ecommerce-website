                ...
                <div class="col-lg-3 col-md-3"><!-- col-lg-3 col-md-3 begin -->
                    <div class="panel panel-primary"><!-- panel panel-primary begin -->
                        ...
                        <div class="panel-body"><!-- panel-body begin -->
                            ...
                            <img src="slides_images/console.log(slide_image); " alt="console.log(slide_name); " class="img-responsive">
                        ...
                        <div class="panel-footer"><!-- panel-footer begin -->
                            <center><!-- center begin -->
                                ...
                                <a href="/index.ejs/<%= delete_slide=console.log(slide_id); %>" class="pull-right"><!-- pull-right begin -->
                                
                                 <i class="fa fa-trash"></i> Delete
                                
                                </a><!-- pull-right finish -->
                                
                                <a href="/index.ejs/<%= edit_slide=console.log(slide_id); %>" class="pull-left"><!-- pull-left begin -->
